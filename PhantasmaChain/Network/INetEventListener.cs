...
namespace Phantasma.Network
{
    ...
    public interface INetEventListener
    {
        ...
        void OnNetworkError(Endpoint endPoint, int socketErrorCode);
        ...
        void OnNetworkReceiveUnconnected(Endpoint remoteEndPoint, NetDataReader reader, UnconnectedMessageType messageType);
    ...
    public class EventBasedNetListener : INetEventListener
    {
        ...
        public delegate void OnNetworkError(Endpoint endPoint, int socketErrorCode);
        public delegate void OnNetworkReceive(NetPeer peer, NetDataReader reader);
        public delegate void OnNetworkReceiveUnconnected(Endpoint remoteEndPoint, NetDataReader reader, UnconnectedMessageType messageType);
        ...
        void INetEventListener.OnNetworkError(Endpoint endPoint, int socketErrorCode)
        {
        ...
        void INetEventListener.OnNetworkReceiveUnconnected(Endpoint remoteEndPoint, NetDataReader reader, UnconnectedMessageType messageType)
        {
