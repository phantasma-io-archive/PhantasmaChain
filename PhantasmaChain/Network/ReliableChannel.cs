...
namespace Phantasma.Network
{
    internal sealed class ReliableChannel
    {
        ...
        private readonly Packet[] _receivedPackets;       //for order
        ...
        public ReliableChannel(NetPeer peer, bool ordered, int windowSize)
        {
            ...
            _outgoingPackets = new Queue<Packet>(_windowSize);
            ...
            if (_ordered)
                _receivedPackets = new Packet[_windowSize];
            else
        ...
        public void ProcessAck(Packet packet)
        {
            ...
            for (int i = 0; i < _windowSize; i++)
            {
                ...
                {
                    Packet removed = _pendingPackets[storeIdx].GetAndClear();
