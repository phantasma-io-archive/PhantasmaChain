...
namespace Phantasma.Blockchain.Utils
{
    ...
    public class ChainSimulator
    {
        ...
        public void FillNachoMarket()
        {
            ...
            //        CallContract(owner_keys, "SellWrestler", new object[] { owner_keys.Address, ID, TokenUtils.ToBigInteger(price), TokenUtils.ToBigInteger(price), AuctionCurrency.NACHO, Constants.MAXIMUM_AUCTION_SECONDS_DURATION, "" });
            //    }
            //}
            ...
            //        CallContract(owner_keys, "SellItem", new object[] { owner_keys.Address, itemID, TokenUtils.ToBigInteger(price), TokenUtils.ToBigInteger(price), AuctionCurrency.NACHO, Constants.MAXIMUM_AUCTION_SECONDS_DURATION, "" });
            //    }
            //}
        }
