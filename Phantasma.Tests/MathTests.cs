...
namespace Phantasma.Tests
{
    ...
    public class MathTests
    {
        ...
        {
            var x = new LargeInteger("", 16);
        ...
        public void TestLeftShift()
        {
            ...
            //testing extra digit
            var target = new LargeInteger("", 16);
            var y = x << 1000;  
            Assert.IsTrue(y == target);

            //testing no extra digit
            target = new LargeInteger("", 16);
            y = x << 1281;  
            Assert.IsTrue(y == target);
        }
        ...
        {
            var x = new LargeInteger("111230981409285093459012840956983409578093148394857023194801239875784567834568931749081123437456abecdf", 16);
            
            //to test extra shrinkage off
            var target = new LargeInteger("11123098140928509345901284095698340957809314839485702", 16);
            var y = x >> 196;
            Assert.IsTrue(y == target);
            
            //to test extra shrinkage on
            target = new LargeInteger("111230981409285093459012840956983409578093148394", 16);
            y = x >> 216;   
            Assert.IsTrue(y == target);
        }
        ...
        public void TestXor()
        {
            ...
            LargeInteger x = new LargeInteger(bx, 16);
            LargeInteger y = new LargeInteger(by, 16);
