...
namespace Phantasma.Tests
{
    ...
    public class VMTests
    {
        ...
        {
            var encoded = "";
            var decodeTeam = Base16.Decode(encoded);
            var temp = VMObject.FromBytes(decodeTeam);
            var teamDecode = temp.AsStruct<Team>();
            ...
            var xp = 0;
            var level = 0;
            var state = CharacterState.Ingame;
            var isBot = 0;
            var teamID = 0;
        ...
        [TestMethod]
        public void TestCharacterROMFromEncode()
        {
            string encodedROM = "010804044E616D65040E72656C797468206C697468766972040453656564030543ADDB2B0004064865616C74680302700004044D616E610303740100040641747461636B030238000407446566656E73650302960004055370656564030213000407456C656D656E740705";
            var decodedROM = Base16.Decode(encodedROM);
            var characterROMDecoded = VMObject.FromBytes(decodedROM).AsStruct<CharacterROM>();
            
            Assert.IsTrue(characterROMDecoded.Name == "relyth lithvir");
            Assert.IsTrue(characterROMDecoded.Seed == 735817027);
            Assert.IsTrue(characterROMDecoded.Health == 112);
            Assert.IsTrue(characterROMDecoded.Attack == 56);
            Assert.IsTrue(characterROMDecoded.Defense == 150);
            Assert.IsTrue(characterROMDecoded.Speed == 19);
            Assert.IsTrue(characterROMDecoded.Mana == 372);
            Assert.IsTrue(characterROMDecoded.Element == ElementType.Steel);
        }
    }
}
