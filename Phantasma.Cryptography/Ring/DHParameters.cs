...
namespace Phantasma.Cryptography.Ring
{
    public static class KnownGroupParameters
    {
        public static GroupParameters RFC5114_2_3_256 = new GroupParameters(@"87A8E61D B4B6663C FFBBD19C 65195999 8CEEF608 660DD0F2
                                                                        ...
                                                                        693877FA D7EF09CA DB094AE9 1E1A1597".HexToBigInteger(),
                                                                        ...
                                                                        5E2327CF EF98C582 664B4C0F 6CC41659".HexToBigInteger(),

                                                                        @"8CF83642 A709A097 B4479976 40129DA2 99B1A47D 1EB3750B
                                                                        A308B0FE 64F5FBD3".HexToBigInteger());
        ...
        public static GroupParameters RFC5114_2_2_224 = new GroupParameters(@"AD107E1E 9123A9D0 D660FAA7 9559C51F A20D64E5 683B9FD1
                                                                          ...
                                                                          CF9DE538 4E71B81C 0AC4DFFE 0C10E64F".HexToBigInteger(),
                                                                          ...
                                                                          81BC087F 2A7065B3 84B890D3 191F2BFA".HexToBigInteger(),

                                                                          @"801C0D34 C58D93FE 99717710 1F80535A 4738CEBC BF389A99
                                                                          B36371EB".HexToBigInteger());
        ...
        public static GroupParameters RFC5114_2_1_160 = new GroupParameters(@"B10B8F96 A080E01D DE92DE5E AE5D54EC 52C99FBC FB06A3C6
                                                                          ...
                                                                          DF1FB2BC 2E4A4371".HexToBigInteger(),
                                                                          ...
                                                                          855E6EEB 22B3B2E5".HexToBigInteger(),

                                                                           @"F518AA87 81A8DF27 8ABA4E7D 64B7CB9D 49462353".HexToBigInteger());
