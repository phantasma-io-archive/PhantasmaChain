...
namespace Phantasma.Cryptography.ECC
{
    public class ECCurve
    {
        ...
        (
            ...
            new BigInteger(Base16.Decode("00FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC").Reverse().ToArray()),
            new BigInteger(Base16.Decode("005AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B").Reverse().ToArray()),
            new BigInteger(Base16.Decode("00FFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551").Reverse().ToArray()),
